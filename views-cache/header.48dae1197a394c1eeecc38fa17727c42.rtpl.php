...
<head>
  ...
  <title>Hcode Store - Administração</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/admin" class="logo">
      ...
      <span class="logo-mini"><b>HS</b>ADM</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Hcode Store </b>ADM</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo htmlspecialchars( $user_name, ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo htmlspecialchars( $user_name, ENT_COMPAT, 'UTF-8', FALSE ); ?>
